package com.example.springgoesai.output;
...
public class SongsController {
    ...
    @GetMapping("/songs")
    public List<String> getSongsByArtist(@RequestParam(value = "artist", defaultValue = "Sid Sriram") String artist) {
        var message = """
...
//    @GetMapping("/songs")
//    public String getSongsByArtist(@RequestParam(value = "artist", defaultValue = "Sid Sriram") String artist) {
//        var message = """
//                Please give me a list of top 10 songs for the artist {artist}.  If you don't know the answer , just say "I don't know".
//                """;
